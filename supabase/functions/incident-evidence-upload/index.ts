// STAGING ONLY promotion candidate — production deployment is not authorized.
//
...
import { sniffMime, sha256Hex } from "../_shared/incident-evidence-mime-sniff.ts";
import { checkRateLimit, recordRateEvent } from "../_shared/incident-evidence-rate-limit.ts";
