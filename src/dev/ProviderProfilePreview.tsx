    ...
    <main className="min-h-screen bg-[hsl(210_60%_98%)]">
      <div className="mx-auto max-w-4xl px-4 pt-3 sm:px-6">
        <details
          ...
          className="rounded-xl border border-dashed border-[hsl(222_60%_82%)] bg-white/70 px-3 py-2 text-xs"
        >
          <summary className="cursor-pointer list-none text-[11px] font-semibold text-[hsl(222_88%_42%)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(222_88%_42%)]">
            Preview: {current.label}
          </summary>
          <div className="mt-2 flex flex-wrap gap-1.5" role="group" aria-label="Vælg preview-case">
            {PREVIEW_CASES.map((c) => (
              <button
                key={c.id}
                type="button"
                ...
                className={
                  "rounded-full px-2.5 py-1 text-xs font-medium transition-colors motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(222_88%_42%)] " +
                  (c.id === caseId
            ...
            <button
              ...
              className="rounded-full border border-[hsl(222_60%_88%)] px-2.5 py-1 text-xs font-medium text-[hsl(224_45%_25%)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(222_88%_42%)]"
            >
