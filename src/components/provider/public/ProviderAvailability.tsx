    ...
    <section data-testid="provider-availability" className="space-y-4">
      ...
      {slots !== null && days.length > 0 && (
        <>
                  ...
                  {hours.slice(0, 4).map((h) => {
                    ...
                    return (
                      <button
                        ...
                        className={
                          "inline-flex min-h-[44px] min-w-[3.25rem] items-center justify-center rounded-lg border px-2.5 text-[13px] font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(222_88%_42%)] focus-visible:ring-offset-1 motion-reduce:transition-none " +
                          (isSelected
          ...
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-y-0 right-0 hidden w-12 bg-gradient-to-l from-[hsl(210_60%_98%)] to-transparent sm:block"
          />
          </div>
