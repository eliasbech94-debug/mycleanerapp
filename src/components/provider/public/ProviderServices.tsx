  ...
  return (
    <section data-testid="provider-services" className="space-y-4">
      ...
      {/* Horizontal snap rail on every breakpoint: ~4–5 cards visible on desktop,
          ...
          A soft right-edge fade signals that the rail continues. */}
      <div className={few ? undefined : "relative"}>
        <div
          className={
            few
              ? "grid gap-4 sm:grid-cols-2"
              : "-mx-4 flex snap-x snap-mandatory scroll-px-4 gap-4 overflow-x-auto px-4 pb-2 sm:mx-0 sm:scroll-px-0 sm:px-0"
          }
          {...(few ? {} : { role: "group", "aria-label": t("ui.servicesAndPrices") })}
        >
