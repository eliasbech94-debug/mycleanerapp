...
// Live status is covered by its own suite; stub it so this file stays offline.
vi.mock("@/hooks/useProviderLiveStatus", () => ({
  useProviderLiveStatus: () => ({ status: null, loading: false, error: null, refresh: async () => {} }),
  useProviderLiveStatuses: () => ({
    statuses: new Map(),
    get: () => null,
    loading: false,
    error: null,
