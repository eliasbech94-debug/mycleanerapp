  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between px-5 lg:px-8">
        ...
        <nav className="hidden items-center gap-7 lg:flex" aria-label={t("nav.primary", "Primary")}>
          {primary.map((l) => (
            <Link
              key={`${l.to}-${l.label}`}
              to={l.to}
              className="relative flex h-11 items-center whitespace-nowrap rounded-md px-1 text-[13.5px] font-medium text-[hsl(var(--mkt-ink-muted))] transition-colors after:absolute after:inset-x-1 after:bottom-2.5 after:h-px after:origin-left after:scale-x-0 after:bg-[hsl(var(--mkt-brand))] after:transition-transform hover:text-[hsl(var(--mkt-ink))] hover:after:scale-x-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--mkt-brand))] focus-visible:ring-offset-2"
            >
              {l.label}
            </Link>
          ))}
          ...
          {user ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="h-11 gap-2 whitespace-nowrap px-4 text-[hsl(var(--mkt-ink))]">
            ...
            <>
              <Button variant="ghost" size="sm" className="h-11 whitespace-nowrap px-4" onClick={() => openLogin({ reason: "navbar" })}>
                {t("nav.sign_in", "Log in")}
              </Button>
              <Button
                size="sm"
                onClick={openRegister}
                className="h-11 whitespace-nowrap px-5 bg-[hsl(var(--mkt-brand))] text-[hsl(var(--mkt-brand-on))] shadow-[0_8px_20px_-10px_hsl(var(--mkt-brand)/0.9)] transition hover:bg-[hsl(var(--mkt-brand-hover))] active:scale-[0.98] motion-reduce:active:scale-100"
              >
        ...
        <button
          type="button"
          className="-mr-2 inline-flex h-11 w-11 items-center justify-center rounded-xl text-[hsl(var(--mkt-ink))] transition-colors hover:bg-[hsl(var(--mkt-surface-muted))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--mkt-brand))] focus-visible:ring-offset-2 lg:hidden"
          ...
          <nav className="space-y-1" aria-label={t("nav.tablet_mobile", "Tablet and mobile primary")}>
            {primary.map((l) => (
              <Link
                ...
                className="flex min-h-[44px] items-center rounded-lg px-3 py-2 text-[14px] font-medium text-[hsl(var(--mkt-ink))] hover:bg-[hsl(var(--mkt-surface-muted))]"
              >
                {l.label}
              </Link>
            ))}
