...
export function AuthShell({
  ...
  return (
    <main
      ...
      className="min-h-dvh w-full overflow-x-hidden bg-[hsl(210_60%_98%)] text-[hsl(224_45%_16%)]"
    >
      <div className="mx-auto flex min-h-dvh w-full max-w-6xl">
        ...
        {/* Form column */}
        <div
          className="flex w-full flex-col px-4 pt-3 sm:px-8 lg:px-12"
          style={{
        ...
        >
          <div className="flex items-center justify-between">
            <button
              ...
              onClick={() => navigate(-1)}
              aria-label="Tilbage"
              className="inline-flex h-11 w-11 items-center justify-center rounded-full text-[hsl(224_45%_16%)] transition-colors hover:bg-[hsl(222_88%_42%/0.08)] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(222_88%_42%)] focus-visible:ring-offset-2"
            >
              <ArrowLeft className="h-5 w-5" aria-hidden="true" />
            </button>
            <Link
              to="/"
              aria-label="MyCleaner forside"
              className="inline-flex h-11 items-center rounded-lg px-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(222_88%_42%)] lg:hidden"
            >
          ...
          <div className="flex flex-1 items-start justify-center pt-3 sm:items-center sm:pt-0">
