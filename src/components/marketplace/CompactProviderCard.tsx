...
export function CompactProviderCard({ provider: p, to, className = "", liveStatus = null }: CompactProviderCardProps) {
  ...
  const displayName = p.display_name?.trim() || "MyCleaner-partner";
  ...
  return (
    ...
    >
      <Link
        to={href}
        aria-label={`${displayName} — se profil`}
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-1 p-4">
          ...
          {liveStatus && <ProviderStatusPill status={liveStatus} size="sm" className="mt-0.5" />}
